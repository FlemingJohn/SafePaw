    ...
    <section className="relative pt-24 pb-12 md:pt-48 md:pb-32 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 md:px-12 flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        >
          ...
          >
            Superior care and the best dog training
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Professional dog training and behavior services tailored to your pet's personality. We help you build a stronger bond with your companion.
          </motion.p>
          <motion.div 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          >
            ...
            <div>
              <p className="text-[10px] md:text-xs font-bold text-gray-400 uppercase tracking-widest">Happy Pets</p>
              <p className="text-sm md:text-lg font-bold text-[#2D2424]">10k+ Trained</p>
            </div>
          </motion.div>
        </motion.div>
      </div>
